    ...
    <main className="p-8 max-w-[1600px] mx-auto flex flex-col gap-8 pb-24">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <h1 className="text-3xl font-extrabold text-text-primary mt-1">Client Settings & Personalization</h1>
          <p className="text-sm text-text-secondary">Customize portal appearance, language, notification preference channels, accessibility, and active device sessions.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card variant="glass" className="p-6 flex flex-col gap-5 text-xs">
          <h3 className="text-sm font-bold text-text-primary border-b border-border-subtle pb-2">Appearance & Language Preferences</h3>
          ...
          <div className="flex justify-between items-center p-3.5 rounded-xl bg-surface-base border border-border-subtle">
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-text-tertiary">Luxury Metallic Gold Dark Theme</span>
            </div>
        ...
        <Card variant="glass" className="p-6 flex flex-col gap-5 text-xs">
          <h3 className="text-sm font-bold text-text-primary border-b border-border-subtle pb-2">Notification Channel Preferences</h3>

          <div className="flex justify-between items-center p-3.5 rounded-xl bg-surface-base border border-border-subtle">
            <div className="flex flex-col">
              <span className="font-bold text-text-primary">In-App Notification Alerts</span>
              <span className="text-[10px] text-text-tertiary">Instant alerts when gallery or album proof updates</span>
            </div>
            <Button variant={inAppAlerts ? 'primary' : 'secondary'} size="sm" onClick={() => setInAppAlerts(!inAppAlerts)}>
          ...
          <div className="flex justify-between items-center p-3.5 rounded-xl bg-surface-base border border-border-subtle">
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-text-tertiary">Transactional invoice receipts and studio notes</span>
            </div>
            <Button variant={emailAlerts ? 'primary' : 'secondary'} size="sm" onClick={() => setEmailAlerts(!emailAlerts)}>
      ...
      <Card variant="glass" className="p-6 flex flex-col gap-4 text-xs">
        <h3 className="text-sm font-bold text-text-primary border-b border-border-subtle pb-2">Active Session Security & Storage Summary</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-3.5 rounded-xl bg-surface-base border border-border-subtle flex flex-col gap-1">
            ...
            <span className="font-bold text-text-primary text-xs">Chrome on Windows 11 (IP 103.42.18.9)</span>
