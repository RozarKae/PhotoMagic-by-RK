...
export const CategorizedDownloadCenter: React.FC = () => {
  const downloadPacks = [
    {
      name: 'High-Resolution RAW Photos ZIP',
      size: '8.4 GB',
      type: '300 DPI Original RAW',
      downloads: 14,
      icon: FileArchive,
    },
    {
      name: 'Social Media Optimized Kit (WebP)',
      size: '420 MB',
      type: 'Instagram / Reels Sizes',
      downloads: 28,
      icon: ImageIcon,
    },
    {
      name: 'Print-Ready Italian Album PDF',
      size: '1.2 GB',
      type: '24K Gold Foil Master PDF',
      downloads: 6,
      icon: BookOpen,
    },
    {
      name: 'Cinematic 8K Wedding Film (MP4)',
      size: '4.8 GB',
      type: 'ProRes 422 8K UHD',
      downloads: 8,
      icon: Film,
    },
  ];
      ...
      <div className="flex justify-between items-center pb-2 border-b border-border-subtle">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-bold text-text-primary">
            Categorized High-Speed Download Center
          </h3>
        </div>
