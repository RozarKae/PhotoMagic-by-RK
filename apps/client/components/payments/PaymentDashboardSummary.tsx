    ...
    <Card variant="glass" className="p-6 flex flex-col gap-6">
      <div className="flex justify-between items-center pb-2 border-b border-border-subtle">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-bold text-text-primary">Client Payment & Invoicing Dashboard</h3>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
        <div className="p-4 rounded-xl bg-surface-base border border-border-subtle flex flex-col justify-between">
          ...
          <span className="text-2xl font-extrabold text-text-primary font-mono mt-1">${totalAmount.toLocaleString()}</span>
        ...
        <div className="p-4 rounded-xl bg-surface-base border border-border-subtle flex flex-col justify-between">
          ...
          <span className="text-2xl font-extrabold text-status-success font-mono mt-1">${amountPaid.toLocaleString()}</span>
          <span className="text-[10px] text-status-success font-semibold mt-2">Retainer Received</span>
        </div>

        <div className="p-4 rounded-xl bg-surface-base border border-border-subtle flex flex-col justify-between">
          <span className="text-text-tertiary">Outstanding Balance Due</span>
          <span className="text-2xl font-extrabold text-gold-500 font-mono mt-1">${balanceDue.toLocaleString()}</span>
          <span className="text-[10px] text-gold-500 font-semibold mt-2">Due on Album Approval</span>
        </div>
      </div>
