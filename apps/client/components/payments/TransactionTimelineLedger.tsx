...
export const TransactionTimelineLedger: React.FC = () => {
  const transactions = [
    {
      id: 'tx-1',
      name: '50% Retainer Advance Payment',
      amount: '$4,500',
      method: 'Razorpay (Card **** 4242)',
      date: 'Jul 01, 2026',
      status: 'paid',
      receipt: 'REC-2026-001.pdf',
    },
    {
      id: 'tx-2',
      name: 'Final Balance Payment',
      amount: '$4,500',
      method: 'Pending Album Approval',
      date: 'Due Aug 06, 2026',
      status: 'pending',
      receipt: null,
    },
  ];
