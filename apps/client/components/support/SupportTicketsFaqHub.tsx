...
export const SupportTicketsFaqHub: React.FC = () => {
  ...
  const faqs = [
    { q: 'How long does album delivery take after approval?', a: 'Once you digitally approve your album proof, printing and gold-foil binding take 7–10 business days.', category: 'Album' },
    { q: 'Can I request additional retouching after initial selection?', a: 'Yes! You have up to 2 revision rounds included in your package. Submit retouch requests via the proofing portal.', category: 'Gallery' },
    { q: 'How do I download high-resolution RAW files?', a: 'High-resolution ZIP archives are accessible in your Final Delivery tab with your private PIN.', category: 'Delivery' },
  ];
    ...
    <Card variant="glass" className="p-6 flex flex-col gap-6">
      <div className="flex justify-between items-center pb-2 border-b border-border-subtle">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-bold text-text-primary">Studio Support Center & FAQ Knowledgebase</h3>
        </div>
        <div className="flex items-center gap-2">
      ...
      <div className="flex flex-col gap-2.5 text-xs">
        {filteredFaqs.map((faq, idx) => (
          <div key={idx} className="p-3.5 rounded-xl bg-surface-base border border-border-subtle flex flex-col gap-2">
            ...
            >
              <div className="flex items-center gap-2">
                <Badge variant="gold" className="text-[9px]">{faq.category}</Badge>
                <span>{faq.q}</span>
              </div>
