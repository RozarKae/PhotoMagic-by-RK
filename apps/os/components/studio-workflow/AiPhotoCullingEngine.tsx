      ...
      <div className="flex justify-between items-center pb-2 border-b border-border-subtle">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-bold text-text-primary">
            Phase 9.3 Intelligent AI Photo Culling & Expression Filtering
          </h3>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            <div className="flex justify-between items-center">
              <span className="font-semibold text-text-secondary">
                AI Expression & Sharpness Threshold ({cullingSensitivity}%)
              </span>
            </div>
            <input
              type="range"
          ...
          <div className="p-3.5 rounded-xl bg-surface-base border border-border-subtle flex flex-col gap-1">
            ...
            <span className="font-mono text-[10px] text-text-primary">
              ✔ Motion & Lens Blur Rejection
            </span>
            <span className="font-mono text-[10px] text-text-primary">
              ✔ Closed Eyes & Blinking Facial Mask
            </span>
            <span className="font-mono text-[10px] text-text-primary">
        ...
        <div className="grid grid-cols-2 gap-3 text-xs">
          ...
          <div className="p-3.5 rounded-xl bg-surface-base border border-border-subtle flex flex-col justify-between">
            ...
            <span className="text-2xl font-extrabold text-gold-500 font-mono">
              {cullingStats.approvedFavorites}
            </span>
          ...
          <div className="p-3.5 rounded-xl bg-surface-base border border-border-subtle flex flex-col justify-between">
            ...
            <span className="text-2xl font-extrabold text-status-error font-mono">
              {cullingStats.rejectedBlur + cullingStats.rejectedClosedEyes}
            </span>
          ...
          <div className="p-3.5 rounded-xl bg-surface-base border border-border-subtle flex flex-col justify-between">
            ...
            <span className="text-2xl font-extrabold text-text-secondary font-mono">
              {cullingStats.duplicatesGrouped}
            </span>
