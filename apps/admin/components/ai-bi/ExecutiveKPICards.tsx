    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <Card variant="glass" className="p-6 flex flex-col justify-between">
        <div className="flex justify-between items-center mb-4">
          <span className="text-xs font-semibold uppercase text-text-tertiary">Monthly Revenue</span>
        ...
        <span className="text-xs text-status-success font-semibold mt-1">+18.4% vs Previous Month</span>
      </Card>

      <Card variant="glass" className="p-6 flex flex-col justify-between">
        <div className="flex justify-between items-center mb-4">
          <span className="text-xs font-semibold uppercase text-text-tertiary">Net Profit Margin</span>
        ...
        <span className="text-xs text-status-success font-semibold mt-1">High Profitability Benchmark</span>
      </Card>

      <Card variant="glass" className="p-6 flex flex-col justify-between">
        <div className="flex justify-between items-center mb-4">
          <span className="text-xs font-semibold uppercase text-text-tertiary">Lead Conversion Rate</span>
          <div className="p-2 rounded-full bg-gold-500/10 text-gold-500 border border-gold-500/20">
            <Users size={18} />
          </div>
        </div>
      ...
      <Card variant="glass" className="p-6 flex flex-col justify-between">
        <div className="flex justify-between items-center mb-4">
          <span className="text-xs font-semibold uppercase text-text-tertiary">Team Utilization</span>
          <div className="p-2 rounded-full bg-gold-500/10 text-gold-500 border border-gold-500/20">
            <Activity size={18} />
          </div>
        </div>
        <span className="text-3xl font-extrabold text-text-primary">88.5%</span>
        <span className="text-xs text-status-success font-semibold mt-1">Optimal Crew Allocation</span>
      </Card>
    </div>
  );
};
