  ...
  const promptTokens = [
    {
      ...
      options: [
        ...
        'Haute Couture Model',
        'Groom in Tuxedo',
        'Fine Art Studio Model',
      ],
    },
    {
      category: 'Clothing',
      options: [
        'Raw Silk Gold Sherwani',
        'Velvet Lehenga',
        'Italian Tailored Tuxedo',
        'Minimalist Linen',
      ],
    },
    {
      category: 'Pose',
      options: [
        'Candid Over-the-Shoulder Glance',
        'Symmetrical Studio Stance',
        'Elegantly Walking',
        'Seated Regal Pose',
      ],
    },
    ...
    },
    {
      category: 'Background',
      options: [
        'Udaipur Heritage City Palace',
        'Paris Eiffel Tower View',
        'Obsidian Black Studio Drop',
        'Ornate Marble Courtyard',
      ],
    },
    {
      category: 'Mood & Color',
      options: [
        'Warm Vintage Film Tones',
        'Monochrome High-Contrast',
        'Rich Emerald & Gold Palette',
        'Pastel Soft Dream',
      ],
    },
  ];
      ...
      <div className="flex justify-between items-center pb-2 border-b border-border-subtle">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-bold text-text-primary">
            1-Click Professional Prompt Builder
          </h3>
        </div>
      ...
      <div className="flex flex-col gap-4 text-xs">
        {promptTokens.map((group, idx) => (
          <div key={idx} className="flex flex-col gap-2">
            <span className="font-semibold text-gold-500 uppercase tracking-wider text-[10px]">
              {group.category}
            </span>
