    ...
    <Card variant="glass" className="p-6 flex flex-col gap-5">
      <div className="flex justify-between items-center pb-2 border-b border-border-subtle">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-bold text-text-primary">Multi-Tenant Subdomain & White-Label Domain Manager</h3>
        </div>
      ...
      <div className="p-4 rounded-xl bg-surface-base border border-border-subtle flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 text-xs">
        <div className="flex flex-col gap-0.5">
          <span className="font-bold text-text-primary">Remove "Powered by PhotoMagic" Footer Watermark</span>
          <span className="text-[10px] text-text-tertiary">Applies custom CSS variables, studio logo, and custom login screens for client portal.</span>
        </div>
        <Button
