...
export const VersionManagerPanel: React.FC = () => {
  const [versions, setVersions] = useState<ImageVersionRecord[]>([
    ...
    {
      id: 'v-2',
      versionName: 'v1.1 Auto Color & Exposure',
      filename: 'DSC_0042_v1.1.png',
      size: '12.4 MB',
      isOriginal: false,
      active: false,
    },
    {
      id: 'v-3',
      versionName: 'v1.2 AI Retouched Master',
      filename: 'DSC_0042_v1.2.png',
      size: '14.8 MB',
      isOriginal: false,
      active: true,
    },
        ...
        {versions.map((v) => (
          <div
            ...
            className={`p-3.5 rounded-xl border flex justify-between items-center ${
              v.active ? 'bg-gold-500/10 border-gold-500' : 'bg-surface-base border-border-subtle'
            }`}
          >
