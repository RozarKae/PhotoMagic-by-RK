  ...
  const roles = [
    {
      ...
      permissions: 'Full Read/Write/Delete/Billing/AI',
    },
    {
      role: 'Branch Manager',
      scope: 'Single Branch',
      permissions: 'Manage Staff, Equipment, Invoices',
    },
    {
      role: 'Senior Photographer',
      scope: 'Assigned Shoots',
      permissions: 'Gallery Upload, Client Proofing',
    },
    {
      role: 'Master Editor',
      scope: 'Post-Production',
      permissions: 'AI Photo Editing, Album Canvas',
    },
  ];
